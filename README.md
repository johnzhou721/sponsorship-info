...
There are two options for sponsoring my FOSS work:
...
- **Sponsoring me to develop specific features and bugfixes for projects I contribute to or maintain.**
  ...
  Sponsorships involving third-party projects only fund my development work. Any resulting contribution will be submitted and reviewed through the project's normal upstream process, without special treatment by the maintainers.
...
These are all invididual sponsorships;  Please, see general disclaimers above.  The prices are negotiable, and the amounts listed cover the entirety of the implementation of the ticket only (NOT upstream integration).
...
If you'd like to sponsor me for any other feature that has a complete design, **contact me and I may do it**.
